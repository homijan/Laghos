...
SOURCE_FILES = laghos.cpp laghos_solver.cpp laghos_assembly.cpp nonlocalinteg.cpp
OBJECT_FILES1 = $(SOURCE_FILES:.cpp=.o)
OBJECT_FILES = $(OBJECT_FILES1:.c=.o)
HEADER_FILES = laghos_solver.hpp laghos_assembly.hpp pnonlocaloperator.hpp nonlocalinteg.hpp
