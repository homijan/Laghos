...
SOURCE_FILES = laghos.cpp laghos_solver.cpp laghos_assembly.cpp m1_solver.cpp m1_assembly.cpp
OBJECT_FILES1 = $(SOURCE_FILES:.cpp=.o)
OBJECT_FILES = $(OBJECT_FILES1:.c=.o)
HEADER_FILES = laghos_solver.hpp laghos_assembly.hpp m1_solver.hpp m1_assembly.hpp
